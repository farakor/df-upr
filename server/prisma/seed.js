...
async function main() {
    ...
    const manager = await prisma.user.upsert({
        ...
        create: {
            ...
            passwordHash: await bcryptjs_1.default.hash('manager123', 12),
            firstName: 'Менеджер',
            lastName: 'Столовой',
    ...
    const warehouses = await Promise.all([
        prisma.warehouse.upsert({
            ...
            create: {
                name: 'Основной склад',
                type: client_1.WarehouseType.MAIN,
        ...
        prisma.warehouse.upsert({
            ...
            create: {
                name: 'Кухня №1',
                type: client_1.WarehouseType.KITCHEN,
        ...
        prisma.warehouse.upsert({
            ...
            create: {
                name: 'Столовая №1',
                type: client_1.WarehouseType.RETAIL,
